package com.example.poowadon.liveat500px.manager;
...
public class PhotoListManager {
    ...
    public void appendtDaoAtBottomPosition(PhotoItemCollectionDao newDao){
        if (dao == null)
            dao = new PhotoItemCollectionDao();
        if(dao.getData() == null)
            dao.setData(new ArrayList<PhotoItemDao>());
